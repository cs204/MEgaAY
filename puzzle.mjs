...
знания2.добавить(new Эквивалентность(new Эквивалентность(АЛжец, БЛжец), АРыцарь))
знания2.добавить(new Эквивалентность(new Не(new Эквивалентность(АЛжец, БЛжец)), БРыцарь))
    // Добавьте

// Задача 3
// А сказал, но вы не услышали.
